...
namespace FantaziaDesign.Wpf.Interactivity
{
	public interface IEventArgsConverter
	{
		...
		/// the <see cref="EventHandlerCommandAction.EventArgsConverterParameter"/> property
		/// to set this value. This may be null.</param>
		/// <returns>The converted value.</returns>
		object Convert(object value, object parameter);
	}

	public class EventHandlerCommandAction : TriggerAction<DependencyObject>
	{
		/// <summary>
		...
		public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register(
			"CommandParameter",
			typeof(object),
			typeof(EventHandlerCommandAction),
			new PropertyMetadata(
				null,
				(s, e) =>
				{
					var sender = s as EventHandlerCommandAction;
					if (sender == null)
					{
						return;
					}
		...
		public static readonly DependencyProperty CommandProperty = DependencyProperty.Register(
			...
			new PropertyMetadata(
				null,
				(s, e) => OnCommandChanged(s as EventHandlerCommandAction, e)));
		...
		private static void OnCommandChanged(
			EventHandlerCommandAction element,
